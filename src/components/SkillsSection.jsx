  ...
  return (
    <SectionShell id="skills">
      <SectionHeading
        ...
        title="Stack depth across the systems that matter."
        description="Grouped the way I actually work: architecture and leadership first, then execution layers. Not every badge I’ve ever touched."
      />
